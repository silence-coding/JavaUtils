...
!function () {
    ...
    function l() {
        ...
        if ((navigator.userAgent.match(/(phone|pad|pod|iPhone|iPod|ios|iPad|Android|Mobile|BlackBerry|IEMobile|MQQBrowser|JUC|Fennec|wOSBrowser|BrowserNG|WebOS|Symbian|Windows Phone)/i))) {
            return {l: w, zIndex: -2, opacity:  0.7, color:  "0,0,255", count: 16}
        }
        else {
            return {l: w, zIndex:  -2, opacity: 0.7, color: "0,0,255", count: 66}
        }
    ...
    u.id = c;
    u.style.cssText = "position:fixed;top:0;left:0;z-index:" + s.zIndex + ";opacity:" + s.opacity;
